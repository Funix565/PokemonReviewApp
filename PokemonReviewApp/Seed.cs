                ...
                var pokemonOwners = new List<PokemonOwner>()
                {
                    ...
                    new PokemonOwner()
                    {
                        Pokemon = new Pokemon()
                        {
                            ...
                            Reviews = new List<Review>()
                            {
                                new Review { Title = "Venasuar", Text = "Venasuar is the best pokemon, because it is leaf", Rating = 5,
                                Reviewer = new Reviewer() { FirstName = "Teddy", LastName = "Smith" } },
                                new Review { Title = "Venasuar", Text = "Venasuar is the best a killing rocks", Rating = 5,
                                Reviewer = new Reviewer() { FirstName = "Taylor", LastName = "Jones" } },
